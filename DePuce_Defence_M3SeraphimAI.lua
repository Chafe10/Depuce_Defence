...
function Seraphim_M3_South_West_Base_Land_Attacks(PlayerCount)
    local opai = nil
	local Temp = {
		'Seraphim_M3_South_West_Base_Land_Attack_Template_1',
		'NoPlan',
		{ 'xsl0307', 1, (6+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },  # T3 Shield Generator
		{ 'xsl0303', 1, (8+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },  # T3 T3 Siege Tank
		{ 'xsl0205', 1, (4+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },   # T2 AA
		{ 'xsl0202', 1, (2+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },  # T2 Assualt Bot
	}
	local Builder = {
		BuilderName = 'Seraphim_M3_South_West_Base_Land_Attack_Builder_1',
		PlatoonTemplate = Temp,
		InstanceCount = 3,
		Priority = 120,
		PlatoonType = 'Land',
		...
		PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
		PlatoonData = {
			PatrolChains = {'Seraphim_M3_Land_Attack_Chain_1', 'Seraphim_M3_Land_Attack_Chain_2', 'Seraphim_M3_Land_Attack_Chain_3'}
		},
	}
	ArmyBrains[Seraphim]:PBMAddPlatoon( Builder )
	
	local Temp = {
		'Seraphim_M3_South_West_Base_Land_Attack_Template_2',
		'NoPlan',
	...
	local Builder = {
		BuilderName = 'Seraphim_M3_South_West_Base_Land_Attack_Builder_2',
		PlatoonTemplate = Temp,
		InstanceCount = 2,
		Priority = 110,
		PlatoonType = 'Land',
		RequiresConstruction = true,
		LocationType = 'SeraphimO2North_Base',
		PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
		PlatoonData = {
			PatrolChains = {'Seraphim_M3_Land_Attack_Chain_1', 'Seraphim_M3_Land_Attack_Chain_2', 'Seraphim_M3_Land_Attack_Chain_3'}
		},
	...
	local Temp = {
		'Seraphim_M3_South_West_Base_Land_Attack_Template_3',
		'NoPlan',
		{ 'xsl0305', 1, (8+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },   # T3 Seige Tank
		{ 'xsl0205', 1, (6+PlayerCount/2)*UnitModifier[Difficulty], 'Attack', 'GrowthFormation' },   # T2 AA
	}
	local Builder = {
		BuilderName = 'Seraphim_M3_South_West_Base_Land_Attack_Builder_3',
		PlatoonTemplate = Temp,
		InstanceCount = 4,
		Priority = 105,
		PlatoonType = 'Land',
